...
/**
 * @typedef {Object} Notifier Tracks a user's request to be notified about a vault
...
/**
 * @typedef {Object} Notification A record of each Notification sent to a user
 * @property {number} id - The ID of the notifier. auto-generated by AUTOINCREMENT
 * @property {number} userId - The ID of the user that this notifier belongs to. This is a foreign key reference to the `id` field in the `Users` table.
 * @property {number} vaultManagerId - The ID of the vaultManager (collateralType) that this notifier is related to.
 * @property {number} vaultId - The ID of the vault that this notifier is related to.
 ...
 * @property {IssuerName} inIssuerName
 * @property {IssuerName} outIssuerName
 ...
 * @property {string} NETWORK_CONFIG_URL url containing chain configuration
 * @property {string} [TEST_RPC] rpc url to use for CI tests
 * @property {string} [TEST_CHAIN_NAME] chainName to use for CI tests
 */

/** @typedef {keyof ProcessEnv} ProcessEnvKey */
